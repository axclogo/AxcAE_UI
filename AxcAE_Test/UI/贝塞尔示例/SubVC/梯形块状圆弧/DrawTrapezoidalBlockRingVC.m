...
#import "DrawTrapezoidalBlockRingVC.h"

@interface DrawTrapezoidalBlockRingVC ()
// 声明一个画板视图
...
@implementation DrawTrapezoidalBlockRingVC
...
- (CAShapeLayer *)layerBrush{
    if (!_layerBrush) {
        // 创建绘制动作路径
        UIBezierPath *bezierPath = [AxcDrawPath AxcDrawTrapezoidalBlockArcRingCenter:CGPointMake(200, 200)  // 中心
